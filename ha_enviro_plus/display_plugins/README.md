...
This directory contains user-created display plugins for ha-enviro-plus. Plugins in this directory will be automatically discovered and added to the display cycle.

## Default Plugin

The default sensor display (showing time/date, temperature, humidity, and pressure) is implemented as `SensorDisplayPlugin` in `ha_enviro_plus/display_plugins.py`. This plugin serves as the reference implementation and is automatically registered and available.
